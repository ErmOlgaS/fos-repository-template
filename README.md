...
**Основные задачи.** Освоить классы, инкапсуляцию, наследование, полиморфизм и интерфейсы. Научиться использовать коллекции, generics, исключения, файловый ввод-вывод и прикладные библиотеки Java. Сформировать базовые навыки многопоточного программирования и работы с реляционными БД через JDBC. Реализовать простой ETL-пайплайн с обработкой ошибок, логированием, метриками и идемпотентной загрузкой. Научиться применять LLM для генерации, рефакторинга и проверки кода без потери инженерного контроля.

**Структура и содержание.** Дисциплина состоит из 7 модулей: Основы ООП. Коллекции, обобщения и исключения. Ввод-вывод. Многопоточность. Базы данных и JDBC. ETL-пайплайн. Промпт-инжиниринг. Обучение включает лекции / лабораторные работы / проект / самостоятельную работу и завершается экзаменом / защитой проекта.

**Пререквизиты и связи с другими дисциплинами.** основы программирования;алгоритмы и структуры данных;дискретная математика;базы данных: реляционная модель, SQL DDL/DML, транзакции, ACID, индексы и нормализация.
